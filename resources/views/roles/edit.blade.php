            ...
            <div class="col-12">
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title">Ubah peran</h3>
                    </div>
                    <div class="card-body">
                        @if (count($errors) > 0)
                        ...
                        <form method="POST" action="{{ route('roles.update', $role->id) }}">
                            ...
                            <div class="form-group form-floating mb-3">
                                <input value="{{ $role->name }}" type="text" class="form-control" name="name" placeholder="Nama peran" required>
                            ...
                            <div style="  width: 100%; height: 400px; overflow-y: scroll;">
                                <table class="table table-striped">
                                    <thead>
                                        ...
                                        <th scope="col" width="20%">Nama izin</th>
